    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden bg-white">
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        <div className="mb-12 w-full opacity-20">
          <svg viewBox="0 0 800 50" preserveAspectRatio="none" className="w-full h-8" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              fill="none" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
            />
          </svg>
        </div>

        <h1 className="text-[52px] font-black leading-[1.05] tracking-tight mb-6 text-zinc-900">
          감정은 결정을<br />바꿀까요?
        </h1>
        ...
        <button
          ...
          className="px-8 py-3 bg-zinc-900 text-white text-sm font-bold rounded-full hover:bg-zinc-700 transition-colors duration-150"
        >
          시작하기
        </button>
